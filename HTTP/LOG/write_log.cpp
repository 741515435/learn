/*************************************************************************
    > File Name: write_log.cpp
    > Author: xxx
    > Mail: XXX.com
    > Created Time: 2017年07月22日 星期六 09时48分12秒
 ************************************************************************/
...
void Log::write_log(int level, const char * format, ...)
{
    ...
    string log_str;
    pthread_mutex_lock(m_mutex);
    int n = snprintf(m_buf, 48, "%d-%02d-%02d %02d:%02d:%02d.%06d %s ", my_tm.tm_year+1900, my_tm.tm_mon+1, my_tm.tm_mday,  
